...
int main(int argc, char *argv[])
{
	...
	desired_state.motor_id = 200;
	desired_state.motor_pos = 300;
	while(1)
	{
		
		desired_state.motor_id = desired_state.motor_id;
		send_state_data(desired_state,csend);
		desired_state = receive_state_data(ssend);
